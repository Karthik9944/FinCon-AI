        ...
        if not exp_df.empty:
            ...
            for i, row in exp_df.iterrows():
                ...
                row_html = (
                    ...
                    f"<td style='padding: 10px 12px; font-weight: 700; color: #818CF8; white-space: nowrap; vertical-align: top; min-width: 105px;'>{html.escape(str(row['Order ID']))}</td>"
                    f"<td style='padding: 10px 12px; color: #9CA3AF; white-space: nowrap; vertical-align: top; min-width: 105px;'>{html.escape(str(row['Date']))}</td>"
                    f"<td style='padding: 10px 12px; color: #E2E8F0; vertical-align: top; min-width: 120px;'>{html.escape(str(row['Customer']))}</td>"
                    f"<td style='padding: 10px 12px; color: #CBD5E1; vertical-align: top; min-width: 140px;'>{html.escape(str(row['Product']))}</td>"
                    f"<td style='padding: 10px 12px; text-align: right; font-weight: 700; color: #F9FAFB; white-space: nowrap; vertical-align: top; min-width: 110px;'>{html.escape(str(row['Amount (INR)']))}</td>"
                    f"<td style='padding: 10px 12px; vertical-align: top; min-width: 150px;'><span style='color: {status_color}; font-weight: 700;'>{html.escape(status_str)}</span></td>"
                    f"<td class='reasoning-cell' style='padding: 10px 12px; color: #F3F4F6; white-space: normal !important; word-wrap: break-word !important; word-break: break-word !important; line-height: 1.45; vertical-align: top; min-width: 250px;'>{reasoning_clean}</td>"
                    f"</tr>"
                )
            ...
            html_table = (
                ...
                f"<th style='padding: 12px 10px; text-align: left; width: 10%; min-width: 105px; font-family: \"Outfit\", sans-serif; font-weight: 700; color: #9CA3AF;'>Order ID</th>"
                f"<th style='padding: 12px 10px; text-align: left; width: 10%; min-width: 105px; font-family: \"Outfit\", sans-serif; font-weight: 700; color: #9CA3AF;'>Date</th>"
                f"<th style='padding: 12px 10px; text-align: left; width: 12%; min-width: 120px; font-family: \"Outfit\", sans-serif; font-weight: 700; color: #9CA3AF;'>Customer</th>"
                f"<th style='padding: 12px 10px; text-align: left; width: 14%; min-width: 140px; font-family: \"Outfit\", sans-serif; font-weight: 700; color: #9CA3AF;'>Product</th>"
                f"<th style='padding: 12px 10px; text-align: right; width: 11%; min-width: 110px; font-family: \"Outfit\", sans-serif; font-weight: 700; color: #9CA3AF;'>Amount (INR)</th>"
                f"<th style='padding: 12px 10px; text-align: left; width: 15%; min-width: 150px; font-family: \"Outfit\", sans-serif; font-weight: 700; color: #9CA3AF;'>Reconciliation Status</th>"
                f"<th style='padding: 12px 10px; text-align: left; width: 28%; min-width: 250px; font-family: \"Outfit\", sans-serif; font-weight: 700; color: #9CA3AF;'>Audit Trail Reasoning</th>"
                f"</tr>"
                f"</thead>"
